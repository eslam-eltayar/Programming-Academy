...
namespace XpertAcademy.Core.Specifications.Courses
{
    public class AllCourseSpecifications : BaseSpecification<Course>
    {
        public AllCourseSpecifications(PaginationDto paginationDto)
        {
        ...
        public AllCourseSpecifications()
        {
